// flow-typed signature: 5436833bbb2c1a91cc2ef746ae3c8f05
// flow-typed version: b43dff3e0e/flatbuffers_v1.5.x/flow_>=v0.16.x
...
declare module "flatbuffers" {
  ...
  declare class ByteBuffer {
    ...
    __offset(number, number): number,
    __string(number, optionalEncoding?: EncodingValue): string | null,
    __vector(number): number,
    __vector_len(number): number,
    __indirect(number): number,
    __union<T: Table>(T, number): T,
    bytes(): Uint8Array,
    position(): number,
