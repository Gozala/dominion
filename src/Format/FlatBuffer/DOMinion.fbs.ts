 ...
 * @returns {RemoveEventListener}
 */
static getRootAsRemoveEventListener(bb:flatbuffers.ByteBuffer, obj?:RemoveEventListener):RemoveEventListener {
 ...
 * @returns {flatbuffers.Offset}
 */
static endRemoveEventListener(builder:flatbuffers.Builder):flatbuffers.Offset {
  var offset = builder.endObject();
  return offset;
};
